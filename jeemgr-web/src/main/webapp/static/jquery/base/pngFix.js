 ...
 * http://dillerdesign.com/experiment/DD_belatedPNG/#license Download by
 * http://www.codefans.net Example usage: DD_belatedPNG.fix('.png_bg'); //
 * argument is a CSS selector DD_belatedPNG.fixPng( someNode ); // argument is
 * an HTMLDomElement
 */
var DD_belatedPNG = {
	ns : "DD_belatedPNG",
