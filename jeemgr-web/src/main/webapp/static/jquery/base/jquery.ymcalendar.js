...
(function($) {
	...
	function create(target) {
		...
		target.click(function() {
			...
			y = target.val() != "" ? target.val().substring(0,target.val().length-3) : y; /*changed by gaohui 2014-7-17*/
			...
			for (var i = 0; i < 12; i++) {
				...
				td.mousedown(function() {
					...
					var newval = year.attr("year")+"-"+mon;/*changed by gaohui 2014-7-17*/
					if (target.val() != newval) {
						target.val(year.attr("year")+"-"+mon);/*changed by gaohui 2014-7-17*/
